...
def mainGame():
    ...
    # Create two pipes blitting on the screen
...
def getRandomPipe():
    """
    Generate position of two pipes (one bottom straigth and one top rotated) for blitting on the screen
    """
    pipeHeight = GAME_SPRITES["pipe"][0].get_height()
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Flappy Bird By Tejas")
